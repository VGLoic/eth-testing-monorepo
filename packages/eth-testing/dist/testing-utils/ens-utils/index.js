...
var ens_utils_exports = {};
__export(ens_utils_exports, {
    EnsUtils: function() {
        return EnsUtils;
    }
});
module.exports = __toCommonJS(ens_utils_exports);
...
var EnsUtils = /*#__PURE__*/ function() {
   ...
   */ key: "mockResolver",
            value: function mockResolver(name) {
                ...
                var callValues = name ? {
                    callValues: [
                        import_ethers3.ethers.utils.namehash(name)
                    ]
                } : void 0;
   ...
   */ key: "mockAllToEmpty",
            value: function mockAllToEmpty() {
                ...
                this.publicResolverUtils.mockCall("addr(bytes32)", [
                    import_ethers3.ethers.constants.AddressZero
                ], void 0, {
                    persistent: true
                });
            }
   ...
   */ key: "mockEmptyReverse",
            value: function mockEmptyReverse(addresses) {
                ...
                addresses.forEach(function(address) {
                    ...
                    _this.mockResolver(reverseName, import_ethers3.ethers.constants.AddressZero);
                    var callValues = {
                        callValues: [
                            import_ethers3.ethers.utils.namehash(reverseName)
                        ]
                    };
