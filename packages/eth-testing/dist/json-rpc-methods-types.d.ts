...
type EthSubscribe = {
    ...
    params: ["newHeads"] | ["logs", {
        ...
        topics?: string[];
    }] | ["newPendingTransactions"] | ["syncing"];
    response: string;
};
type EthUnsubscribe = {
...
type JsonRPCMethod = EthAccounts | EthBlockNumber | EthCall | EthChainId | EthCoinbase | EthEstimateGas | EthFeeHistory | EthGetBalance | EthGasPrice | EthGetBlockByHash | EthGetBlockByNumber | EthGetBlockTransactionCountByHash | EthGetBlockTransactionCountByNumber | EthGetCode | EthGetLogs | EthGetStorageAt | EthGetTransactionByBlockHashAndIndex | EthGetTransactionByBlockNumberAndIndex | EthGetTransactionByHash | EthGetTransactionCount | EthGetTransactionReceipt | EthGetUncleByBlockHashAndIndex | EthGetUncleByBlockNumberAndIndex | EthGetUncleCountByBlockHash | EthGetUncleCountByBlockNumber | EthGetWork | EthMining | EthHashrate | EthProtocolVersion | EthSendRawTransaction | EthSendTransaction | EthSign | EthSubmitWork | EthSyncing | NetListening | NetPeerCount | NetVersion | EthSubscribe | EthUnsubscribe | EthSignTransaction | EthPersonalSign | EthSignTypedData | EthRequestAccounts;
type JsonRPCMethodName = JsonRPCMethod["method"];

export { Block, FilterObject, JsonRPCMethod, JsonRPCMethodName, Log, PendingBlock, PendingLog, PendingTransaction, Transaction, TransactionCallPayload, TransactionPayload, TransactionReceipt };
